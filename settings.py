...
# Log the database timezone settings
db_timezone_option = settings.DATABASES['default'].get('OPTIONS', {}).get('options')
print(f"Database timezone option: {db_timezone_option}")

# Log the system timezone
print(f"System timezone: {pytz.timezone('UTC')}")

# Log the Django time zone setting
